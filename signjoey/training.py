...
class TrainManager:
    ...
    def init_from_checkpoint(
        ...
        #     if k in old_model_state.keys() and old_model_state[k].shape == model_checkpoint['model_state'][k].shape:
        #         old_model_state[k] = model_checkpoint['model_state'][k]

        # restore model and optimizer parameters
        self.model.load_state_dict(model_checkpoint['model_state'])  # old_model_state
...
def train(cfg_file: str) -> None:
    ...
    # ckpt = 'data/39150.ckpt'
    ckpt = "{}/{}.ckpt".format(trainer.model_dir, trainer.best_ckpt_iteration)  # trainer.best_ckpt_iteration
    output_name = "best.IT_{:08d}".format(trainer.best_ckpt_iteration)   # trainer.best_ckpt_iteration
