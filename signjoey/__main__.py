...
from signjoey.training_vlp import train as vlp_pretrain
from signjoey.prediction_vlp import test as vlp_test
...
def main():
    ...
    ap.add_argument("mode", choices=["train", "test", "vlp_pretrain", "vlp_test"], help="train a model or test")
    ...
    elif args.mode == "vlp_pretrain":
        vlp_pretrain(cfg_file=args.config_path)
    elif args.mode == "vlp_test":
        vlp_test(cfg_file=args.config_path, ckpt=args.ckpt, output_path=args.output_path)
    else:
