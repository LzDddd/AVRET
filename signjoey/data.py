...
#         random_frame_subsampling=False,
#         random_frame_masking_ratio=False,
#         random_text_masking_ratio=True
#     )
#     # print(batch.txt)
#     # print(batch.txt_input)
#     # print(batch.txt_lengths)
#     print(batch.sgn_mask.shape)
#     print(batch.txt_mask.shape)
#     print('---------------------------------------------------------------------------------')
#     # print(batch.random_masked_txt_input)
#     # print(batch.random_masked_txt_lengths)
#     print(batch.random_masked_txt_input_mask.shape)
#     time.sleep(2)
